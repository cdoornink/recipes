...
export default Ember.Route.extend({
  ...
  matchwords: {
    ...
    specialty: ['deli', 'meat', 'ham', 'turkey', 'good cheese', 'fancy cheese', 'nice crackers', 'fancy crackers', 'good bread', 'fancy bread', 'nice bread', 'french bread', 'ciabatta', 'baugette', 'baggette', 'mozzarella balls', 'pita'],
    spreads: ['peanut', 'honey'],
    bread: ['bread', 'buns', 'hoagies', 'tortillas', 'flour tortilla', 'corn tortilla'],
    ...
    pasta: ['lemon juice', 'lime juice', 'orzo', 'dressing', 'vinegar', 'sauce', 'rigatoni', 'spaghetti', 'noodle', 'tahini', 'macaroni', 'tortellini', 'tortallini', 'tortillini', 'quinoa', 'pasta'],
